class Pet {
    ...
    let pets = [
        new Pet('Two kittens lying down with each other', './images/BabyKittens.jpg', 'Hi! My name is Telma. I have lots of tiny friends. I am a chihuahua puppy and my favorite things are playing with my toys and being loved.'),
        new Pet('A black kitten', './images/Charlo.jpg', 'I am a chihuahua and my favorite things are playing with my toys and being loved.'),
        new Pet('A cat sitting in a chair', './images/Chirp.jpg', 'Hi! My name is Telma. I have lots of tiny friends. I am a chihuahua puppy and my favorite things are playing with my toys and being loved.'),
        new Pet('A white kitten meowing', './images/TeeTee.jpg', 'Hi! My name is Telma. I have lots of tiny friends. I am a chihuahua puppy and my favorite things are playing with my toys and being loved.'),
        new Pet('A cat under a Christmas tree', './images/Fritz.jpg', 'Hi! My name is Telma. I have lots of tiny friends. I am a chihuahua puppy and my favorite things are playing with my toys and being loved.'),
